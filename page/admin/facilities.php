...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Facilities Management</h1>
            <br>
          </div><!-- /.col -->
          <div class="col-sm-6">
           ...
           <div class="col-sm-6">
            <ol class="breadcrumb float-sm-left">
             <a href="#" class="btn btn-secondary" data-toggle="modal" data-target="#add_facility">Add Facility</a>
            </ol>
          </div>
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-info">
              ...
              <form>
                <div class="card-body">
                   <div class="row">
                    <div class="col-3">
                    <label>Facility Name:</label> <input type="text" name="facility_name" id="facility_name" class="form-control">
                    </div>
                    <div class="col-3">
            ...
            <tbody id="list_of_facilities" style="text-align:center;"></tbody>
            </table>
             <div class="row">
                  <div class="col-6">
